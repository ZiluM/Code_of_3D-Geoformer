...
class modelTrainer:
    ...
    def train_model(self, dataset_train, dataset_eval,model_name = "Geoformer.pkl"):
...
if __name__ == "__main__":
    ...
    logger.info(str(mypara.__dict__))
    print("\nloading pre-train dataset...")
    logger.info("loading pre-train dataset...")
